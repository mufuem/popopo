...
UUID=${UUID:-'fb224f7e-d6bb-448e-b1f7-2e3153dbb584'}
VMESS_WSPATH=${VMESS_WSPATH:-'/fb224f7e-d6bb-448e-b1f7-2e3153dbb584-vmess'}
VLESS_WSPATH=${VLESS_WSPATH:-'/fb224f7e-d6bb-448e-b1f7-2e3153dbb584-vless'}
TROJAN_WSPATH=${TROJAN_WSPATH:-'/fb224f7e-d6bb-448e-b1f7-2e3153dbb584-trojan'}
SS_WSPATH=${SS_WSPATH:-'/fb224f7e-d6bb-448e-b1f7-2e3153dbb584-shadowsocks'}
